...
export function ChatPanel({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center gap-1 shrink-0">
          {messages.length > 0 && onClear && (
            <button
              type="button"
              onClick={onClear}
              className="flex items-center gap-1.5 text-xs text-ink-faint hover:text-ink px-2 py-1.5 rounded-lg hover:bg-bg-elevated transition-all"
            >
          ...
          <button
            type="button"
            className="hidden sm:flex w-7 h-7 rounded-lg items-center justify-center text-ink-faint hover:text-ink hover:bg-bg-elevated transition-all"
      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-5 py-4 sm:py-5 space-y-4 sm:space-y-5 overscroll-contain">
        {messages.length === 0 ? (
          emptyState ?? (
